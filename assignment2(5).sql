...
(1, 'https://cdn.pixabay.com/photo/2015/10/29/14/39/web-1012469_1280.jpg');
...
(4, 'asdasdasd', 'asdasdas@gmail.com', 'redtcfhvgjhbknm', '2024-03-27 13:23:30');
...
CREATE TABLE `users` (
  ...
  `role` enum('user','admin','editor') NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
